...
if [ $# -eq 0 ]; then
  ...
  if [ $define_stage_file_proxy -eq 1 ]; then
    ...
    ddev drush en admin_toolbar admin_toolbar_tools admin_toolbar_search examples stage_file_proxy devel devel_debug_log devel_php backup_migrate examples -y
