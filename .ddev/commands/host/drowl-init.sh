...
ddev composer require --dev drupal/core-dev drush/drush phpunit/phpunit drupal/coder:8.3.13 phpspec/prophecy-phpunit phpstan/phpstan mglaman/phpstan-drupal phpstan/phpstan-deprecation-rules kint-php/kint
