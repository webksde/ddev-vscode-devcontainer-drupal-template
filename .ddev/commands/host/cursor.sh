...
## Description: Open Cursor attached to the Web-Container of the current Project
## Usage: cursor
## Example: "ddev cursor"
...
cursor --folder-uri=vscode-remote://attached-container+$(printf "$WEBSERVER_NAME" | od -A n -t x1 | sed 's/ *//g' | tr -d '\n')/var/www/html
