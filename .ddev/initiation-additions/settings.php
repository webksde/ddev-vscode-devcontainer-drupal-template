...
# Comment in, if in need of a migration db:
...
//   'password' => 'db',
//   'prefix' => '',
//   'host' => 'ddev-my-project-migration-db',
//   'port' => '3306',
//   'driver' => 'mysql',
// ];
...
if(!empty($_SERVER['HTTP_HOST'])){
  ...
  if(strpos($_SERVER['HTTP_HOST'], 'dev')){
    ...
    // STAGING / PREVIEW:
    $config['environment_indicator.indicator']['bg_color'] = '#FFCC00';
    $config['environment_indicator.indicator']['fg_color'] = '#000';
    $config['environment_indicator.indicator']['name'] = '@PREVIEW';

  } elseif (strpos($_SERVER['HTTP_HOST'], 'demo.') !== FALSE){
    // DEMO:
    $config['environment_indicator.indicator']['bg_color'] = '#ff00a5';
    $config['environment_indicator.indicator']['fg_color'] = '#FFF';
    $config['environment_indicator.indicator']['name'] = '@DEMO';
  } elseif (strpos($_SERVER['HTTP_HOST'], 'vorlage.') !== FALSE){
    // VORLAGE:
    $config['environment_indicator.indicator']['bg_color'] = '#83B53E';
    $config['environment_indicator.indicator']['fg_color'] = '#FFF';
    $config['environment_indicator.indicator']['name'] = '@VORLAGE';
  } else {
    // LIVE
    $config['environment_indicator.indicator']['bg_color'] = '#327EBD';
    $config['environment_indicator.indicator']['fg_color'] = '#FFF';
